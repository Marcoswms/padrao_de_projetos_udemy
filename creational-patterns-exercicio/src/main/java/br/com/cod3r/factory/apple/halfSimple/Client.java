...
public class Client {
    ...
    public static void main(String[] args) {
        IPhoneFactory iphoneGenXFac = new IPhoneXFactory();
        IPhoneFactory iphoneGen11Fac = new IPhone11Factory();

        System.out.println("### Ordering an iPhone X");
        IPhone iphoneXLevel = iphoneGenXFac.orderIphone("standard");
        System.out.println(iphoneXLevel);

        System.out.println("\n\n### Ordering an iPhone 11 HighEnd");
        IPhone iphone11Level = iphoneGen11Fac.orderIphone("highEnd");
        System.out.println(iphone11Level);
    }
}